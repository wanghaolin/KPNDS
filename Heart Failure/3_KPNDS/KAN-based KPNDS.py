...
for fold, (train_index, test_index) in enumerate(skf.split(df, df['re.admission.within.3.months'])):
    ...
    y_train_global = train_data['re.admission.within.3.months']
    ...
    X_val_embed = val_data.iloc[:, 110:238]
    ...
    for model, name in models:
        ...
        while best_f1 < MIN_F1_1 and MIN_F1_1 > 0.34:
            MIN_F1_1 -= 0.02
    ...
    # X_train_embed multi-label: y_classifier_train
    ...
    for i in range(X_train_embed.shape[0]):
        ...
        for classifier_idx, classifier_with_threshold in enumerate(final_classifier_pool):
            ...
            if pred == true_label:
                y_classifier_train[i, classifier_idx] = 1
